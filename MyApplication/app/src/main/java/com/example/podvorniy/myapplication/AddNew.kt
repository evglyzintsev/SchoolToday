...
class AddNew : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        pub.setOnClickListener {
            ...
            val r = khttp.post("http://5.63.159.177:5000/api/school-events/add/api/school-events/add", data = mapOf("date" to "23123",
                    "time" to "21", "class" to "na", "short_description" to des.text.toString().slice(IntRange(0, 9)) + des.text.toString(),
